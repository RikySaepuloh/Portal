...
//import kotlinx.android.synthetic.main.activity_woosim.*
//
...
//            ImagePrintable.Builder(R.drawable.ic_hamburger, resources)
//                .setAlignment(DefaultPrinter.ALIGNMENT_RIGHT)
//                .build(),
//            ImagePrintable.Builder(R.drawable.ic_hamburger, resources).build(),
//            ImagePrintable.Builder(R.drawable.ic_hamburger, resources).build()
//        )
//
//        printing.print(printables)
